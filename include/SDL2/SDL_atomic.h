...
#define SDL_AtomicCAS(a, oldval, newval)                                       \
  (_InterlockedCompareExchange((long *)&(a)->value, (newval), (oldval)) ==     \
   (oldval))
#define SDL_AtomicSetPtr(a, v) _InterlockedExchangePointer((a), (v))
#if _M_IX86
#define SDL_AtomicCASPtr(a, oldval, newval)                                    \
  (_InterlockedCompareExchange((long *)(a), (long)(newval), (long)(oldval)) == \
   (long)(oldval))
#else
#define SDL_AtomicCASPtr(a, oldval, newval)                                    \
  (_InterlockedCompareExchangePointer((a), (newval), (oldval)) == (oldval))
#endif
...
#define SDL_AtomicCAS(a, oldval, newval)                                       \
  OSAtomicCompareAndSwap32Barrier((oldval), (newval), &(a)->value)
#ifdef __LP64__
#define SDL_AtomicCASPtr(a, oldval, newval)                                    \
  OSAtomicCompareAndSwap64Barrier((int64_t)(oldval), (int64_t)(newval),        \
                                  (int64_t *)(a))
#else
#define SDL_AtomicCASPtr(a, oldval, newval)                                    \
  OSAtomicCompareAndSwap32Barrier((int32_t)(oldval), (int32_t)(newval),        \
                                  (int32_t *)(a))
#endif
...
#define SDL_AtomicCAS(a, oldval, newval)                                       \
  __sync_bool_compare_and_swap(&(a)->value, oldval, newval)
#define SDL_AtomicCASPtr(a, oldval, newval)                                    \
  __sync_bool_compare_and_swap(a, oldval, newval)
