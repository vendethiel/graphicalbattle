...
extern DECLSPEC Mix_Music *SDLCALL
    Mix_LoadMUSType_RW(SDL_RWops *src, Mix_MusicType type, int freesrc);
...
extern DECLSPEC void SDLCALL
    Mix_SetPostMix(void (*mix_func)(void *udata, Uint8 *stream, int len),
                   void *arg);
 ...
 */
extern DECLSPEC void SDLCALL
    Mix_HookMusic(void (*mix_func)(void *udata, Uint8 *stream, int len),
                  void *arg);
 ...
 */
extern DECLSPEC void SDLCALL
    Mix_HookMusicFinished(void (*music_finished)(void));
 ...
 */
extern DECLSPEC void SDLCALL
    Mix_ChannelFinished(void (*channel_finished)(int channel));
